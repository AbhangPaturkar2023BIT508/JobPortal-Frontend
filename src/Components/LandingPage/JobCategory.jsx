...
const JobCategory = () => {
  return (
    <div className="mt-20 pb-5">
      ...
      <div className="text-lg sm-mx:text-base xs-mx:text-sm mb-10 text-mine-shaft-300 text-center w-1/2 mx-auto sm-mx:w-11/12">
        ...
        {jobCategory.map((category, index) => (
          <Carousel.Slide key={index}>
            <div className="flex flex-col items-center w-64 sm-mx:w-56 xs-mx:w-48 gap-2 border border-bright-sun-400 p-5 rounded-xl hover:cursor-pointer hover:shadow-[0_0_5px_2px_black] my-5 transition duration-300 ease-in-out !shadow-bright-sun-300">
              ...
              <div className="text-mine-shaft-200 text-xl sm-mx:text-lg xs-mx:text-base font-semibold">
                {category.name}
              </div>
              <div className="text-sm sm-mx:text-lg xs-mx:text-base text-mine-shaft-300 text-center">
                {category.desc}
              </div>
